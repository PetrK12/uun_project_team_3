...
const Errors = require("../api/errors/subject-man-error.js");
...
const logger = LoggerFactory.get("SubjectManAbl");
...
module.exports = new SubjectManAbl();
