...
const Create = {
  ...
  TopicDuplicate: class extends SubjectManUseCaseError {
    constructor() {
      ...
      this.message = "Topic name is already used.";
    }
  },
};
...
const Get = {
  ...
  TopicDaoGetFailed: class extends SubjectManUseCaseError {
    constructor() {
      super(...arguments);
...
const Delete = {
  ...
  TopicDaoDeleteFailed: class extends SubjectManUseCaseError {
    constructor() {
      super(...arguments);
